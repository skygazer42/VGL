...
from examples.homo.node_classification import TinyHomoModel, build_demo_graph, build_demo_loaders
...
def test_end_to_end_homo_neighbor_sampled_training_loop_runs(tmp_path):
