...
def build_tasks(repo_root: Path) -> list[ScanTask]:
    ...
    tasks.extend(
        [
            ...
            _path_exists_task(ctx, "006", "repo", "docs/quickstart.md exists", "docs/quickstart.md"),
    ...
    tasks.extend(
        [
            ...
            _pyproject_equals_task(
                ...
                "https://github.com/skygazer42/sky-vgl#readme",
            ),
            _pyproject_equals_task(
                ctx,
                "018",
    ...
    tasks.extend(
        [
            _text_contains_task(
                ...
                "046",
                "docs",
                "quickstart documents pip install sky-vgl",
                "docs/quickstart.md",
                "pip install sky-vgl",
            ),
            _text_contains_task(
                ...
                "047",
                "docs",
                "quickstart documents sky-vgl[full]",
                "docs/quickstart.md",
            ...
            _text_contains_task(
                ...
                "048",
                "docs",
                "quickstart explains imports remain under vgl",
                "docs/quickstart.md",
